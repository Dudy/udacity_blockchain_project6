...
contract('SupplyChain', accounts => {
    ...
    describe('test every single method of the contract', () => {
        it('Testing smart contract function harvestItem() that allows a farmer to harvest coffee', async function() {
            // perform harvesting
            let transaction = await this.contract.harvestItem(upc, farmer, originFarmName, originFarmInformation, originFarmLatitude, originFarmLongitude, productNotes);
            ...
            assert.equal(transaction.logs[0].event, 'Harvested', 'Harvested event not found');
        ...
        it('Testing smart contract function processItem() that allows a farmer to process coffee', async function() {
            // preparation
            await this.contract.harvestItem(upc, farmer, originFarmName, originFarmInformation, originFarmLatitude, originFarmLongitude, productNotes);

            // perform processing
            let transaction = await this.contract.processItem(upc, {from: farmer});
            ...
            assert.equal(resultBufferTwo[7], emptyAddress, 'Error: Invalid retailer');
            assert.equal(resultBufferTwo[8], emptyAddress, 'Error: Invalid consumer');
            assert.equal(transaction.logs[0].event, 'Processed', 'Processed event not found');
            assert.equal(transaction.logs[0].args.upc, upc, 'Processed event not found for upc ' + upc);
        });
        ...
        it("Testing smart contract function packItem() that allows a farmer to pack coffee", async function() {
            // preparation
            await this.contract.harvestItem(upc, farmer, originFarmName, originFarmInformation, originFarmLatitude, originFarmLongitude, productNotes);
            await this.contract.processItem(upc, {from: farmer});
        ...
        it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async function() {
            ...
            // perform packing
            let transaction = await this.contract.receiveItem(upc, {from: retailer});
        ...
        it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async function() {
            ...
            await this.contract.buyItem(upc, {from: distributor, value: productPrice});
            await this.contract.shipItem(upc, {from: distributor});
            await this.contract.receiveItem(upc, {from: retailer});

            // perform packing
            let transaction = await this.contract.purchaseItem(upc, {from: consumer});
        ...
        it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async function() {
            ...
            await this.contract.shipItem(upc, {from: distributor});
            await this.contract.receiveItem(upc, {from: retailer});
            await this.contract.purchaseItem(upc, {from: consumer});
